...
from graph_retriever_module.modeling_graph_retriever import BertForGraphRetriever
from graph_retriever_module.utils import GraphRetrieverConfig, tokenize_paragraph, InputExample, expand_links_, \
    InputFeatures, tokenize_question
...
def create_examples(jsn, graph_retriever_config):
    ...
    for data in jsn:
        ...
        if graph_retriever_config.expand_links_:
